...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th6 18, 2023 lúc 06:55 AM
...
(13, 'Cánh gà', 102000.00, 3000.00, 'thit_canh-ga.png', '2023-06-03', 'Cánh gà là một phần thịt được lấy từ cánh của con gà. Đây là một phần thịt thường được ưa chuộng và sử dụng phổ biến trong ẩm thực nhiều quốc gia trên thế giới. Cánh gà có cấu trúc xương và thịt cân đối. Phần thịt trên cánh gà thường là mềm mại và có một lượng mỡ nhất định, tạo ra hương vị thơm ngon và độ mềm phù hợ', 1, 4, 16),
(14, 'Đùi gà', 113000.00, 8000.00, 'thit_dui-ga.png', '2023-06-03', 'Đùi gà là một phần thịt được lấy từ phần đùi hoặc chân sau của con gà. Đây là một phần thịt gà phổ biến và được sử dụng rộng rãi trong ẩm thực. Khi chế biến, đùi gà có thể được nướng, quay, rán hoặc hấp theo nhiều phong cách khác nhau. Đùi gà thường được tẩm gia vị hoặc sốt để tăng cường hương vị và độ ngon. Đùi gà cũng thích hợp để làm món chính hoặc món ăn nhẹ', 1, 2, 16),
(15, 'Sườn cừu mông cổ', 720000.00, 22000.00, 'thit_suon-cuu.png', '2023-06-03', 'Sườn cừu Mông Cổ là một sản phẩm thịt từ phần sườn của Cừu Mông Cổ, một loại gia súc được nuôi chủ yếu ở Mông Cổ. Đây là một phần thịt ngon, giàu dinh dưỡng và có một hương vị đặc trưng. Sườn cừu Mông Cổ thường có cấu trúc xương dài và thịt mềm, có nhiều mỡ ở giữa, giúp tạo ra một hương vị giàu mỡ và thơm ngon. Phần thịt được cắt từ sườn cừu thường có lớp mỡ mỏng bao quanh, làm tăng hương vị và giữ cho thịt mềm và không khô', 1, 37, 16),
(16, 'Cá Mập Cambodia', 320000.00, 34000.00, 'slide-ca-tuoi-removebg-preview.png', '2023-06-03', 'Cá Mập Cambodia là một sản phẩm độc đáo được chế biến từ cá mập tươi ngon, nổi tiếng từ vùng biển Cambodia. Sản phẩm này mang đến cho bạn trải nghiệm ẩm thực độc đáo với hương vị đậm đà và thịt cá mập mềm mịn. Với sự kết hợp hoàn hảo giữa phương pháp chế biến truyền thống và công nghệ hiện đại, \"Cá Mập Cambodia\" là một món ăn tuyệt vời để khám phá hương vị biển cả và nền ẩm thực', 1, 27, 17),
(17, 'Cá Chim Trắng Lai Châu', 111000.00, 1000.00, 'ca_chim-trang.png', '2023-06-11', 'Cá chim có hai loại phổ biển là cá chim trắng và cá chim đen, tuy nhiên cá chim trắng được ưa chuộng nhất bởi cá chim trắng thịt ngon và thơm hơn rất nhiều so với cá chim đen.', 0, 0, 17),
(18, 'Cá Saba Lào Cai', 99000.00, 3000.00, 'ca_ba-sa.png', '2023-06-11', 'Cá sa ba tẩm tiêu xanh được nhiều người Việt ưa chuộng bởi độ dinh dưỡng cao và tốt cho sức khỏe. Cá sa ba tẩm tiêu xanh nhập khẩu nguyên liệu trực tiếp từ Nhật về Việt Nam và sau đó bắt đầu sơ chế đóng gói, dán tem, hàng chất lượng tươi ngon.', 0, 0, 17),
(19, 'Cá Hồi Nguyên Con Cao Lãnh', 289000.00, 14000.00, 'ca_hoi-nguyen-con.png', '2023-06-11', 'Cá hồi Nauy là loại thực phẩm giàu dinh dưỡng cho sức khỏe của chúng ta. Chúng được chế biến thành nhiều món ăn ngon, đặc biệt là các món ăn tươi sống như sushi hay sashimi rất được ưa chuộng ở khắp nơi.', 1, 0, 17),
(20, 'Cá Trích Phi Lê', 159000.00, 8000.00, 'ca_trich-phi-le.png', '2023-06-11', 'Cá Trích đặc sản nổi tiếng ở vùng biển Bình Thuận, cá có đặc điểm màu xanh nhẹ, thân dẹp và xương nhỏ. Cá trích Phile được sơ chế từ những con cá trích tươi sống, loại bỏ xương chỉ lấy phần thịt ở 2 bên thân cá.', 0, 0, 17),
(21, 'Cá Tuyết Alaska', 309000.00, 10000.00, 'ca_tuyet-cat-khuc.png', '2023-06-11', 'Là khúc gần cuối đuôi được xẻ làm đôi ( như hình). Khúc này có thịt nhiều thích hợp làm nhiều món như: nấu canh chua, nấu cháo, phi lê thịt cá ra chiên hoặc áp chảo. Ngoài ra, khách có thể để nguyên khúc đuôi kho tiêu rất hấp dẫn.', 1, 0, 17),
(22, 'Cá Dìa Bông Làm Sạch', 169000.00, 6000.00, 'ca_dia-bong.png', '2023-06-11', 'Cá Dìa Bông là hải sản nổi tiếng ở Nha Trang, Cam Ranh được nhiều khách yêu thích. Cá chỉ có theo mùa nên được bán chạy khi có hàng tại Đảo, khách Sài Gòn rất thích ăn cá biển bơi thịt tươi ngon, ngọt và siêu béo.', 1, 0, 17),
(23, 'Cá Dứa 1 Nắng', 143000.00, 5000.00, 'ca_dua.png', '2023-06-11', 'Cá dứa 1 nắng là một món ăn rất quen thuộc với người Việt Nam. Vì từ lâu, loại khô cá này đã có mặt trong mọi bữa ăn của người dân ở khắp các vùng miền. Khô cá dứa được chế biến bằng cách sấy khô cá dứa và trộn các gia vị như đường, muối, tỏi, hành, ớt và dầu ăn để tạo nên hương vị đặc trưng.', 1, 0, 17),
(24, 'Cá Chỉ Vàng 2 Nắng', 78000.00, 2000.00, 'ca_chi-vang.png', '2023-06-11', 'Cá chỉ vàng ( hay còn gọi là cá ngân chỉ ) cá sống tập trung nhiều ở vùng biển ven Phan Thiết - Bình Thuận vì vậy nên khu vực biển này khá nổi tiếng với khô cá chỉ vàng 2 nắng, và là vùng có khô ngon nhất hiện nay.', 1, 0, 17),
(25, 'Cá Chép Sông Đà', 79000.00, 1000.00, 'ca_chep.png', '2023-06-11', 'Cá chép có thể chế biến thành nhiều món ăn hấp dẫn cả thị giác lẫn khứu giác và vị giác. Các món ăn chế biến ngon nhất với nguyên liệu cá chép giòn đó là cá chép giòn nướng muối ớt và cá chép giòn om dưa chua, nướng muối ớt, bạn chỉ cần làm thịt cá chép giòn như hướng dẫn ở trên, sau đó giã một chén muối ớt tùy theo khẩu vị của bạn rồi ướp cá với chút dầu ăn nữa và nướng. Mách nhỏ các bạn ở món này là với phần muối nếu cho thêm ít đường vào sẽ dịu vị cá nướng và ngon hơn.', 1, 0, 17),
(26, 'Cua King Crab', 2600000.00, 90000.00, 'haisan_cua-hoang-de.png', '2023-06-11', 'Cua Hoàng Đế Alaska Cái hay còn gọi là King Crab được nhiều khách hàng ưa chuộng không chỉ tại Việt Nam mà còn rất nhiều nơi trên thế giới vì chất lượng thịt cua được đánh giá là chất lượng ngon ngọt dai mà không có loại hải sản nào có thể vượt mặt được. Vậy cua King Crab cái tại Đảo Hải sản có những đặc điểm gì? Nếu mua nhầm cua kém chất lượng thì Đảo Hải Sản có chính sách gì để bảo vệ khách hàng cùng xem qua nội dung sản phẩm này nhé!', 1, 0, 18),
(27, 'Tôm Hùm Alaska', 999000.00, 11000.00, 'haisan_tom_alaska.png', '2023-06-11', 'So với các loại tôm hùm nội ngoại địa khác thì tôm hùm Alaska baby size nhỏ đang được Đảo Hải Sản nhập khẩu về, đây là dòng sản phẩm được ưa chuộng nhất hiện nay tại Tp Hồ Chí Minh và các tỉnh lân cận. Nếu chúng ta so sánh giá trong tầm 2.000.000đ ngoài những sản phẩm tôm hùm Việt Nam ra thì khách hàng còn có sự lựa chọn tôm hùm alaska', 1, 1, 18),
(28, 'Bào Ngư Hàn Quốc', 899000.00, 12000.00, 'haisan_bao-ngu.png', '2023-06-11', 'Bào ngư là một lọai hải sản nổi tiếng vì độ thơm ngon bổ dưỡng, và nguồn dinh dưỡng quý giá mà chúng mang lại. Vậy đặc điểm của bào ngư, công dụng và cũng như giá thành hiện nay của bào ngư như thế nào, hãy cùng Đảo tìm hiểm qua bài viết sau.', 1, 0, 18),
(29, 'Hàu Nhật Bản', 789000.00, 11000.00, 'haisan_hau.png', '2023-06-11', 'Hàu sữa Nhật Bản, hay còn gọi là hàu nước ngọt, là một loại hàu được nuôi trong môi trường nước ngọt. Nó được coi là một trong những loại hàu ngon nhất thế giới với vị ngọt tự nhiên, mềm mại và tươi mát. Hàu Nhật là một thực phẩm tuyệt vời cho sức khỏe của chúng ta', 1, 0, 18),
(30, 'Sò Đỏ Canada', 543000.00, 5000.00, 'haisan_so-do.png', '2023-06-11', 'Sò đỏ sống trong môi trường sống tự nhiên có tuổi thọ đến vài thập kỷ. Nó được chôn vùi trong cát và lấy lên bằng máy đào thủy lực ngoài đại dương.Sau khi tách vỏ, sò được trải qua quá trình sơ chế và cấp đông nhanh để giữ được chất lượng tuyệt đối cùng hương vị vốn có', 0, 30, 18),
(31, 'Tôm Hùm Úc', 1099000.00, 21000.00, 'haisan_tom-hum-uc.png', '2023-06-11', 'Tôm hùm Tây Úc thu hút ánh nhìn đầu tiên bởi màu sắc thật đẹp, dinh dưỡng cao và đặc biệt thịt tôm rất là thơm, săn chắc và ngọt lắm. Tôm hùm Tây Úc nổi tiếng trên thế giới. Tôm hùm Tây Úc có hình dáng tựa như tôm hùm xanh Nha Trang, chỉ khác về màu sắc đỏ sậm rất bắt mắt. Ngoài ra tôm hùm Tây Úc nhiều khách dễ nhầm lẫn là tôm hùm Nam Úc vì cả 2 chỉ khác nhau hóa văn trên thân tôm.', 1, 0, 18),
(32, 'Cua Tuyết', 669000.00, 4000.00, 'haisan_cua-tuyet.png', '2023-06-11', 'Cua tuyết được nhập sống trực tiếp từ vùng biển nước sâu và cực lạnh khu Bắc Cực, chính vì điều kiện s.ống khắc nghiệt đã tạo nên hương vị đặc trưng của cua tuyết. Được du nhập về Việt Nam thời gian gần đây nhưng đã gây ra \'\'cơn sốt\'\' trong giới sành ăn bởi chất lượng cực đỉnh. Thịt cua chắc từng khối và rất ngọt thịt', 0, 0, 18),
(33, 'Mực Ống 1 Nắng', 234000.00, 11000.00, 'haisan_muc-ong-1-nang.png', '2023-06-11', 'Mực ống 1 nắng là hải sản bán chạy tại shop vào các dịp lễ , tết , tất niên hay những buổi tiệc lớn. Theo ý kiến của nhiều khách hàng , mực 1 nắng thích hợp làm quà tặng , quà biếu cho người thân , đồng nghiệp và bạn bè. Mực ống 1 nắng được làm từ mực ống câu, là loại mực ngon nhất. Những con mực từ biển xanh qua bàn tay con người lại trở nên đặc biệt và thấm đẫm cái tình biển xanh. Mực ống khi câu được ngư dân xẻ và đem đi rửa sạch để giảm bớt nước biển trong con mực, sau đó sẽ đem ra phơi nắng. Phải chọn nơi nhiều ánh nắng, nắng to để mực được ngon hơn', 1, 0, 18),
(34, 'Mực Lá', 320000.00, 10000.00, 'haisan_muc-la.png', '2023-06-11', 'Mực lá bán chạy vào những dịp lễ , cuối tuần , tất niên...khách mua biếu tặng rất nhiều vì hải sản không những ăn ngon mà còn giàu dinh dưỡng , mang nhiều sức khỏe tốt cho mọi gia đình. Mực lá nhiều nhà dân hay xẻ và phơi qua 1 nắng , 2 nắng hay làm khô mực , mực tẩm ướp đều ngon và hấp dẫn. Ngoài ra mực lá làm nhiều món nướng , hấp hành gừng , xào rau củ hay rim me...Chấm kèm tương ớt sẽ ngon hơn . Mực lá thích hợp cho nhiều buổi tiệc liên hoan công ty, sinh nhật hay bạn bè gặp mặt cuối tuần tụ họp . Ngồi lai rai nhấm nhấp và uống chung với bia càng tuyệt vời', 0, 2, 18),
(35, 'Bạch tuộc tươi', 211000.00, 21000.00, 'haisan_bach-tuoc.png', '2023-06-11', 'Bạch tuộc là động vật thân mềm, thịt dày, có vị ngọt mặn tự nhiên của biển và xúc tu giòn dai nên được rất nhiều người yêu thích. Thịt bạch tuộc tươi có giá trị dinh dưỡng cao, nhiều loại khoáng chất như phốt pho, canxi, sắt, đồng, kẽm, iốt, thịt bạch tuộc chứa ít chất béo, itamin thiết yếu như A, B1, B2, C,... giúp bổ máu và tăng cường hệ miễn dịch. Trong thịt bạch tuộc chứa dồi dào canxi, kali, phốt pho, vitamin và một số axit béo omega-3 tốt cho tim và giúp xương chắc khỏe', 1, 0, 18),
(36, 'Bắp Cải Trái Tim', 14000.00, 1000.00, 'rau_bap-cai.png', '2023-06-11', 'Bắp cải trái tim có thể được sử dụng trong nhiều món ăn khác nhau. Nó có thể được ăn sống trong các món salad, hoặc được nấu chín trong các món canh, xào, hấp và trộn. Với hình dáng độc đáo của mình, bắp cải trái tim thường được sử dụng để trang trí đĩa ăn và tạo điểm nhấn hấp dẫn cho bữa ăn.', 1, 0, 19),
(37, 'Bí ngô cô tiên', 12000.00, 1000.00, 'rau_bi.png', '2023-06-11', 'Bí ngô cô tiên là một loại quả bí ngô có hình dáng độc đáo và thu hút sự chú ý. Nó được biết đến với tên khoa học là Cucurbita pepo var. styriaca. Quả bí ngô cô tiên có hình tròn, bề mặt mịn và màu da cam sáng hoặc vàng. Ngoài ra, bí ngô cô tiên cũng có giá trị dinh dưỡng. Nó chứa nhiều chất xơ, vitamin A, vitamin C và khoáng chất như kali, magiê và sắt. Bí ngô cô tiên có vị ngọt và hơi hạt, thích hợp để nấu chín, nướng, xào hoặc chế biến thành các món ăn như súp bí ngô, bánh bí ngô, hay nước ép bí ngô.', 1, 0, 19),
(38, 'Cà rốt Mộc Châu', 9000.00, 1000.00, 'rau_ca-rot.png', '2023-06-11', 'Đặc điểm nổi bật của cà rốt Mộc Châu là nó có hương vị ngọt tự nhiên và giữ được độ giòn sau khi nấu chín. Quả cà rốt này chứa nhiều chất xơ, vitamin A, vitamin C và khoáng chất như kali và sắt, mang lại nhiều lợi ích cho sức khỏe. Cà rốt Mộc Châu thường được sử dụng trong nhiều món ăn như xào, hấp, trộn salad, nấu súp hoặc chế biến thành nước ép cà rốt. Ngoài ra, nó còn được sử dụng trong công thức làm bánh và kem, tạo ra màu sắc và hương vị thú vị.', 1, 0, 19),
(39, 'Cải Chíp', 8000.00, 1500.00, 'rau_cai-chip.png', '2023-06-11', 'Cải Chíp có hình dạng và kích thước nhỏ gọn, thường có chiều cao khoảng 20-30 cm. Lá của nó có dạng rễ, hình thù hơi giống chiếc chìa khóa, có thể ăn được. Lá có mùi thơm đặc trưng và vị ngọt nhẹ. Rau Cải Chíp là một nguồn cung cấp chất xơ, vitamin C, vitamin K và các chất chống oxy hóa. Nó cũng cung cấp một số khoáng chất như kali, canxi và sắt. Rau này có hàm lượng calo thấp, không chứa cholesterol và có chứa chất chống vi khuẩn tự nhiên.', 0, 30, 19),
(40, 'Cải Bó Xôi', 8000.00, 1000.00, 'rau_cai-bo-xoi.png', '2023-06-11', 'Cải Bó Xôi là một nguồn cung cấp chất xơ, vitamin C, vitamin K và các chất chống oxy hóa. Nó cũng cung cấp một số khoáng chất như kali, canxi và sắt. Cải này có hàm lượng calo thấp, không chứa cholesterol và có chứa chất chống vi khuẩn tự nhiên. Cải Bó Xôi thường được sử dụng trong nhiều món ăn như xào, hấp, trộn salad, canh và nấu súp. Với lá xanh dày và cấu trúc độc đáo, nó tạo thêm sự ngon miệng và màu sắc hấp dẫn cho các món ăn.', 1, 0, 19),
(41, 'Vải Bắc Giang', 29000.00, 2000.00, 'hoaqua_vai.png', '2023-06-11', 'Vải Bắc Giang là một loại trái cây đặc sản của tỉnh Bắc Giang, Việt Nam. Loại vải này có tên khoa học là Litchi chinensis và còn được gọi là vải thiều. Vải Bắc Giang có vỏ ngoài màu đỏ tươi, bóng và có những đường nổi lồi nhỏ. Vải Bắc Giang là một loại trái cây ngọt ngào, thơm ngon và giàu dinh dưỡng. Với màu sắc đẹp mắt và vị ngọt tự nhiên, nó là một sản phẩm trái cây được ưa chuộng và thường được coi là một biểu tượng của vùng đất Bắc Giang.', 1, 31, 20),
(42, 'Cam sành', 31000.00, 2000.00, 'hoaqua_cam-sanh.png', '2023-06-11', 'Cam sành là một nguồn cung cấp tuyệt vời của vitamin C và chất chống oxy hóa. Nó cũng chứa chất xơ, vitamin A, kali và các khoáng chất khác có lợi cho sức khỏe. Việc ăn cam sành có thể giúp tăng cường hệ miễn dịch, cung cấp năng lượng và tốt cho da và hệ tiêu hóa. Cam sành thường được ăn tươi, trực tiếp sau khi bóc vỏ. Nó cũng được sử dụng để làm nước ép cam, sinh tố, mứt và các món tráng miệng khác. Cam sành là một loại trái cây mùa hè phổ biến và được ưa chuộng vì hương vị ngon lành và lợi ích dinh dưỡng.', 0, 0, 20),
...
--
ALTER TABLE `loai`
  MODIFY `ma_loai` int(10) NOT NULL AUTO_INCREMENT COMMENT 'mã loại hàng', AUTO_INCREMENT=36;
