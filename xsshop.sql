...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th6 09, 2023 lúc 08:31 AM
...
(28, 'Thịt ba rọi heo', 140000.00, 10000.00, 'thit_ba-roi-heo.png', '2023-06-03', 'Thịt ba chỉ (hay còn gọi là ba rọi) là phần thịt heo được cắt ra từ bụng, không có xương và nhiều mỡ. Sỡ dĩ người ta thường gọi thịt ba chỉ là bởi khi cắt ngang sẽ thấy được phần thịt và mỡ xen kẽ 3 lớp với nhau theo thứ tự lớp thịt, mỡ rồi lại đến lớp thịt', 0, 31, 16),
(29, 'Móng giò', 99000.00, 5000.00, 'thit_mong-gio.png', '2023-06-03', 'Phần móng giò trắng nõn được sơ chế và pha lóc khéo léo, mang trọn hương vị của phần da dẻo mềm mềm, lớp gân giòn và thịt ngọt thơm ngon. Móng giò rất giàu Protit, sau khi đưa vào cơ thể sẽ có tác dụng hiệu quả trong việc cải thiện chức năng sinh lý của các cơ quan nội tạng, làm cho các tế bào da giữ được nước nên đỡ bị khô nhăn, khiến cho da bóng và căng', 1, 2, 16),
...
(31, 'Sườn heo', 160000.00, 12000.00, 'thit_suon-heo.png', '2023-06-03', 'Sườn hồng tươi với sụn giòn rụm cùng thịt mềm căng mọng được tuyển chọn kỹ lưỡng từ tảng sườn ngon nhất. Là nguyên liệ hảo hạng cho món ngon đúng điệu. Sườn heo là bộ phận chứa nhiều các chất dinh dưỡng như protein, vitamin B12, kẽm, sắt và chất béo không bão hòa như Omega-3 giúp cung cấp cho cơ thể loạt các vi chất cần thiết', 1, 3, 16),
...
(42, 'Sườn cừu mông cổ', 720000.00, 32000.00, 'thit_suon-cuu.png', '2023-06-03', 'Sườn cừu Mông Cổ là một sản phẩm thịt từ phần sườn của Cừu Mông Cổ, một loại gia súc được nuôi chủ yếu ở Mông Cổ. Đây là một phần thịt ngon, giàu dinh dưỡng và có một hương vị đặc trưng. Sườn cừu Mông Cổ thường có cấu trúc xương dài và thịt mềm, có nhiều mỡ ở giữa, giúp tạo ra một hương vị giàu mỡ và thơm ngon. Phần thịt được cắt từ sườn cừu thường có lớp mỡ mỏng bao quanh, làm tăng hương vị và giữ cho thịt mềm và không khô', 1, 33, 16),
(43, 'Cá Mập Cambodia', 32000.00, 323223.00, 'slide-ca-tuoi-removebg-preview.png', '2023-06-03', 'Cá Mập Cambodia là một sản phẩm độc đáo được chế biến từ cá mập tươi ngon, nổi tiếng từ vùng biển Cambodia. Sản phẩm này mang đến cho bạn trải nghiệm ẩm thực độc đáo với hương vị đậm đà và thịt cá mập mềm mịn. Với sự kết hợp hoàn hảo giữa phương pháp chế biến truyền thống và công nghệ hiện đại, \"Cá Mập Cambodia\" là một món ăn tuyệt vời để khám phá hương vị biển cả và nền ẩm thực', 1, 21, 17);
...
('123456', '123456', 'longlong', 0, '1.1-removebg-preview.png', 'longdvph29867@fpt.edu.vn', 0),
('212121212', 'Pa$$w0rd!', 'gaso@mailinator.com', 1, '4_1.png', 'myfyj@mailinator.com', 1),
...
--
ALTER TABLE `binh_luan`
  MODIFY `ma_bl` int(10) NOT NULL AUTO_INCREMENT COMMENT 'mã bình luận', AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT cho bảng `hang_hoa`
--
ALTER TABLE `hang_hoa`
  MODIFY `ma_hh` int(11) NOT NULL AUTO_INCREMENT COMMENT 'mã hàng hoá', AUTO_INCREMENT=57;
